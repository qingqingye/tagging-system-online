...
(function () {
    ...
    function displayAnnotationTypeOptions_initial(annotationTypeList) {
    ...
    ////change  L1  drop-down box content
    function displayAnnotationTypeOptions_L0(annotationTypeList) {
        ...
        $('#set_Id_L0').val(selectedOption_L0.val());
        $('#set_Id').val(-1);
    ...
    function displayAnnotationTypeOptions_L1(annotationTypeList) {
        ...
        $('#set_name_L1').val("auto fill in");
        $('#set_code_L1').val("auto fill in");
    ...
    //initialize left drop box and L0
    function loadAnnotationTypeList() {
        $.ajax(API_ANNOTATIONS_BASE_URL + 'annotation/loadannotationtypes/', {
            ...
            success: function (data) {
                displayAnnotationTypeOptions_initial(data.annotation_types);
...
// click L0
    function loadAnnotationTypeList_Click_L0() {
        $.ajax(API_ANNOTATIONS_BASE_URL + 'annotation/loadannotationtypes/', {
            type: 'GET',
            headers: gHeaders,
            dataType: 'json',
            success: function (data) {
                displayAnnotationTypeOptions_L0(data.annotation_types);
            },
            error: function () {
                displayFeedback($('#feedback_connection_error'))
            }
...
//click L1
    function loadAnnotationTypeList_Click_L1() {
        $.ajax(API_ANNOTATIONS_BASE_URL + 'annotation/loadannotationtypes/', {
            type: 'GET',
            headers: gHeaders,
            dataType: 'json',
            success: function (data) {
                displayAnnotationTypeOptions_L1(data.annotation_types);
            },
            error: function () {
                displayFeedback($('#feedback_connection_error'))
            }
    ...
    $(function () {
        ...
        $('select#annotation_type_L0').on('change', loadAnnotationTypeList_Click_L0);
        $('select#annotation_type_L1').on('change', loadAnnotationTypeList_Click_L1);
